...
public class JogaDados3 extends AppCompatActivity {

    public int valorDado1, valorDado2, valorDado3;
    private AdView mAdView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_joga_dados3);
    ...
    public void jogarDados(View view) throws InterruptedException {
        ...
        ImageView imagens = findViewById(R.id.imageView5);
        ...
        ImageView imagens1 = findViewById(R.id.imageView6);
        ...
        ImageView imagens2 = findViewById(R.id.imageView7);
        ...
        int total = valorDado1 + valorDado2 + valorDado3;
        Toast.makeText(JogaDados3.this, "O valor total dos Dados: " + total, Toast.LENGTH_SHORT).show();
    }
}